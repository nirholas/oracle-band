...
/**
 * @title DeployOracleBand
 * @notice Deploys OracleBand deterministically to any chain with a Uniswap v4 `PoolManager`.
 *
 ...
 */
contract DeployOracleBand is Script {
    ...
    function run() external {
        ...
        bytes memory creationCode = type(OracleBandHook).creationCode;
        ...
        console2.log("OracleBand ", predicted);
        ...
        require(
            keccak256(bytes(IHookMetadata(address(hook)).hookName())) == keccak256(bytes("OracleBand")),
